  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="vertical-align : middle;">
        ...
        <a class="btn btn-primary" target="_blank" href="" role="button" style="text-decoration:none">PDF</a>
        <a class="btn btn-primary" target="_blank" href="https://arxiv.org/abs/2111.03162" role="button" style="text-decoration:none">Arxiv</a>
        <a class="btn btn-secondary" target="_blank" href="" role="button" style="text-decoration:none">Poster</a>
        <a class="btn btn-secondary" target="_blank" href="" role="button" style="text-decoration:none">Slides</a>
        ...
        <a class="btn btn-info" target="_blank" href="" role="button" style="text-decoration:none">Cite</a>
        <br>
      </td>
